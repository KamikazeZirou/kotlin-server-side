package com.example.kotlinserverside.integrationtest
...
class IntegrationTests(@Autowired private val webTestClient: WebTestClient) {
    ...
    fun testGetList() {
        val expectedResponse = """
                [
                    { "id": 1, "name": "kiwi", "price": 150 },
                    { "id": 2, "name": "cherry", "price": 250 }
                ]
            """.trimIndent()
